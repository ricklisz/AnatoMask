...
class BYOL(nn.Module):
    def __init__(
        ...
        # stunet = STUNet(1, 1, depth=[1, 1, 1, 1, 1, 1], dims=[32, 64, 128, 256, 512, 512],
        ...
        self.forward(torch.randn(2, 1,112,112,128, device=device),torch.randn(2, 1,112,112,128, device=device))
