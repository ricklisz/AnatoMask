...
def main_pt():
    ...
    os.environ['CUDA_VISIBLE_DEVICES'] = '7,4,6'
    ...
    dec = LightDecoder(enc.downsample_ratio,sbn=True, width = 1536).to(device)
    # dec = SMiMTwoDecoder(enc.downsample_ratio,sbn=False, width = 512).to(device)
    ...
    output_folder = '/home/yl_li/STUNet/nnUNet-1.7.1/nnUNet_results/Dataset666_Big/Pretraining/' + model_name +'_mask60_total_plans'
    ...
    all_keys = splits[fold]['train'] + splits[fold]['val']
    tr_keys, val_keys = train_test_split(all_keys, test_size=0.1, random_state=42)
