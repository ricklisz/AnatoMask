...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_STUNet(
        join(nnUNet_results, 'Dataset501_Total/'  + trainer),
        use_folds=(0,),
        checkpoint_name='checkpoint_best.pth',
    )
    # variant 1: give input and output folders
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset501_Total/imagesTr'),
                                 join(nnUNet_results, 'Dataset501_Total/' + trainer + '/validation'),
