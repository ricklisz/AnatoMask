import inspect
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.STUNet import STUNet
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_UniRep(self, model_training_output_dir: str,
                                             use_folds: Union[Tuple[Union[int, str]], None],
                                             checkpoint_name: str = 'checkpoint_best.pth'):
        """
        This is used when making predictions with a trained model
        ...
        network = UniRepLKUNet(num_input_channels, 105, depth=[1] * 6, dims=[32 * x for x in [1, 2, 4, 8, 16, 16]],
                     LK_kernels=[[3], [3],
                                 [13],
                                 [13], [3]],
                     pool_op_kernel_sizes=[[2,2,2],[2,2,2],[2,2,2],[2,2,2],[1,1,1]], conv_kernel_sizes=[[3, 3, 3]] * 6,
