...
def main_pt():
    ...
    # set your outputfolder here
    output_folder = '/home/yl_li/STUNet/nnUNet-1.7.1/nnUNet_results/XXX/Pretraining/' + model_name +'_mask60'
    ...
    # find your splits
    splits_file = '/scr/yl_li/segmentation_data/nnUNet_preprocessed/XXX/splits_final.json'
    ...
    dataset_json = load_json('/scr/yl_li/segmentation_data/nnUNet_preprocessed/XXX/dataset.json')
    plans = load_json('/scr/yl_li/segmentation_data/nnUNet_preprocessed/XXX/nnUNetPlans.json')
